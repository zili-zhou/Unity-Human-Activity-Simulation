...
namespace RootMotion.Demos
{
    ...
    public class Navigator
    {
        ...
        {
            //TODO CHANGE targetPosition to a vector with only xand z
            //was "if (Find(targetPosition))"
            if (Find(new Vector3(targetPosition.x, 0f, targetPosition.z)))
            {
        ...
        private bool Find(Vector3 targetPosition)
        {
            ...
            {
                //added because partial path is also true 
